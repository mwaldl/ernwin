...
setup(cmdclass={'build_py': build_py},
      ...
      install_requires = [
         ...
         "networkx",
         "future",
         "forgi @ git+https://github.com/mwaldl/logging_exceptions.git@fix_cython_dependency#egg=forgi",
         "logging_exceptions @ git+https://github.com/mwaldl/logging_exceptions.git@fix-python3.8#egg=logging_exceptions",
